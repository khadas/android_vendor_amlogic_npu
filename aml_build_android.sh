...
cp $AQROOT/compiler/androidLib/lib64/libCLC.so $AQROOT/sharelib/
cp $AQROOT/compiler/androidLib/lib64/libLLVM_viv.so $AQROOT/sharelib/
cp $AQROOT/compiler/androidLib/lib64/libVSC.so $AQROOT/build/sdk/drivers/
########################################################
